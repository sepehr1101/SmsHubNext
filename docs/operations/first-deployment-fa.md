...
این راهنما برای راه‌اندازی اولین نسخه عملیاتی روی سرور جدید است. فرض می‌کنیم برنامه از قبل build/publish شده و قرار است روی Windows/IIS کنار SQL Server اجرا شود.
...
1. دیتابیس خالی `SmsHubNext` را بسازید.
