...
public class SmsPartCalculatorTests
{
    ...
    {
        SmsSegmentInfo info = SmsPartCalculator.Calculate("Hello");
    ...
    {
        SmsSegmentInfo info = SmsPartCalculator.Calculate(new string(Gsm, length));
    ...
    {
        SmsSegmentInfo info = SmsPartCalculator.Calculate(text);
    ...
    {
        SmsSegmentInfo info = SmsPartCalculator.Calculate("سلام");
    ...
    {
        SmsSegmentInfo info = SmsPartCalculator.Calculate(new string(Persian, length));
    ...
    {
        SmsSegmentInfo info = SmsPartCalculator.Calculate("😀"); // U+1F600 — a surrogate pair
    ...
    {
        SmsSegmentInfo info = SmsPartCalculator.Calculate(string.Empty);
