...
Guidance for AiCoder when working in the **SmsHubNext** repository. Keep this file concise and high-signal; update it as decisions are made.
...
* **Branch:** develop on the designated feature branch (currently `AiCoder/continue-previous-work-c6qqvn`). Never push elsewhere without explicit permission.
* **Commits:** clear, descriptive messages. Commit author/email must be `AiCoder <noreply@anthropic.com>` so GitHub shows commits as verified.
